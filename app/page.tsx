            ...
            {[
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <Image src="https://images.unsplash.com/photo-1474487548417-781cb71495f3?w=48&h=48&fit=crop&auto=format" alt="Транспорт" width={40} height={40} className="rounded-lg object-cover" />
                </div>
              </Link>
            ))}
          </div>
